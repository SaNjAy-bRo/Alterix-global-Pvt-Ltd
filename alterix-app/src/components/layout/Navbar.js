      ...
      <nav className={`sticky top-0 left-0 w-full transition-all duration-300 z-[1000] border-b ${scrolled ? 'bg-[#002C49] shadow-lg py-4 border-white/10' : 'bg-[#002C49] py-5 border-white/10'}`}>
        <div className="container mx-auto px-6 md:px-12 flex justify-between items-center text-white">
          ...
          <div className="hidden lg:flex gap-8 items-center">
            <Link href="#capabilities" className="text-sm font-bold uppercase tracking-widest hover:text-[#7B9E5A] transition-colors relative group">
              Capabilities<span className="absolute bottom-0 left-0 w-0 h-0.5 bg-[#7B9E5A] transition-all group-hover:w-full"></span>
            </Link>
            ...
            <Link href="#insights" className="text-sm font-bold uppercase tracking-widest hover:text-[#7B9E5A] transition-colors relative group">
              Insights<span className="absolute bottom-0 left-0 w-0 h-0.5 bg-[#7B9E5A] transition-all group-hover:w-full"></span>
            </Link>
        ...
        <div className={`lg:hidden overflow-hidden transition-all duration-300 ${mobileOpen ? 'max-h-[400px] opacity-100' : 'max-h-0 opacity-0'}`}>
          <div className="container mx-auto px-6 pt-4 pb-6 flex flex-col gap-1 border-t border-white/10 mt-4">
            <Link href="#capabilities" onClick={handleLinkClick} className="py-3 px-4 text-sm font-bold uppercase tracking-widest text-white hover:text-[#7B9E5A] hover:bg-white/5 rounded-lg transition-all">
              Capabilities
            </Link>
            ...
            <Link href="#insights" onClick={handleLinkClick} className="py-3 px-4 text-sm font-bold uppercase tracking-widest text-white hover:text-[#7B9E5A] hover:bg-white/5 rounded-lg transition-all">
              Insights
            </Link>
