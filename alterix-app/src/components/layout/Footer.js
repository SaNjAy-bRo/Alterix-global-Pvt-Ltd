...
export default function Footer() {
  return (
    <footer className="bg-[#0B1120] text-slate-100 pt-40 pb-12 relative [clip-path:polygon(0_8vw,100%_0,100%_100%,0%_100%)] mt-[-8vw] z-20">
      ...
      <div className="container mx-auto px-8 relative z-10 grid grid-cols-1 md:grid-cols-2 lg:grid-cols-5 gap-12 lg:gap-16 mb-16">
        <div className="lg:col-span-2 pr-0 lg:pr-8">
          <div className="flex items-center gap-2 text-3xl font-black uppercase mb-6">
             <Hexagon size={36} fill="currentColor" strokeWidth={1} className="text-[#EA580C]" />
          ...
          <div className="flex gap-4">
            <a href="#" className="w-10 h-10 rounded-full bg-white/5 flex items-center justify-center transition-all duration-300 hover:bg-[#EA580C] hover:-translate-y-1 text-white" aria-label="Mail"><Mail size={18} /></a>
            <a href="#" className="w-10 h-10 rounded-full bg-white/5 flex items-center justify-center transition-all duration-300 hover:bg-[#EA580C] hover:-translate-y-1 text-white" aria-label="Chat"><MessageCircle size={18} /></a>
            <a href="#" className="w-10 h-10 rounded-full bg-white/5 flex items-center justify-center transition-all duration-300 hover:bg-[#EA580C] hover:-translate-y-1 text-white" aria-label="Share"><Share2 size={18} /></a>
            <a href="#" className="w-10 h-10 rounded-full bg-white/5 flex items-center justify-center transition-all duration-300 hover:bg-[#EA580C] hover:-translate-y-1 text-white" aria-label="Links"><Link2 size={18} /></a>
          </div>
        </div>
        
        <div>
          <h3 className="text-[#EA580C] text-base font-extrabold uppercase tracking-wide mb-6">Solutions</h3>
        ...
        <div>
          <h3 className="text-[#EA580C] text-base font-extrabold uppercase tracking-wide mb-6">Company</h3>
          <div className="flex flex-col gap-4">
        ...
        <div>
          <h3 className="text-[#EA580C] text-base font-extrabold uppercase tracking-wide mb-6">Insights & Help</h3>
          <div className="flex flex-col gap-4">
