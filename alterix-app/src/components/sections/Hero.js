    ...
    <section className="relative bg-white overflow-hidden [clip-path:polygon(0_0,100%_0,100%_94%,0_100%)] lg:[clip-path:polygon(0_0,100%_0,100%_90%,0_100%)] pb-8 lg:pb-24">
      ...
      <div className="hidden lg:flex min-h-[85vh] items-center">
        <div className="w-[50%] pl-[8%] pr-[4%] py-20">
          <h1 className="text-5xl xl:text-6xl font-black leading-[1.12] tracking-tight mb-8 bg-gradient-to-b from-[#7B9E5A] to-[#64B1C3] bg-clip-text text-transparent">
            Empowering Your Business Through World-Class Talent & Innovative Solutions
          </h1>
          <p className="text-base font-bold text-[#002C49] mb-10 max-w-lg leading-relaxed">
            Strategic staffing, expert consulting, and custom software development — all under one roof to help you scale smarter.
          </p>
      ...
      <div className="lg:hidden relative min-h-[82vh]">
        ...
        <div className="relative z-10 min-h-[82vh] flex items-center justify-center px-5 py-6">
          <div className="bg-white/95 backdrop-blur-sm rounded-2xl shadow-xl p-7 text-left w-full max-w-sm">
            <h1 className="text-[1.6rem] sm:text-[1.75rem] font-black leading-[1.2] tracking-tight mb-4 bg-gradient-to-b from-[#7B9E5A] to-[#64B1C3] bg-clip-text text-transparent">
              Empowering Your Business Through World-Class Talent & Innovative Solutions
            </h1>
            <p className="text-sm font-bold text-[#002C49] mb-6 leading-relaxed">
              Strategic staffing, expert consulting, and custom software — all under one roof to help you scale smarter.
            </p>
